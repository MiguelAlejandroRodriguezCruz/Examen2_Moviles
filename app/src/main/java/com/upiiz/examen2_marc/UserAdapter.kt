...
class UserAdapter(
    private val userList: MutableList<UsuarioEntity>,
    private val onPetClick: (UsuarioEntity) -> Unit,    // Callback para click corto
    private val onUserLongClick: (UsuarioEntity) -> Unit // Callback para click largo
) : RecyclerView.Adapter<UserAdapter.PetViewHolder>() {
